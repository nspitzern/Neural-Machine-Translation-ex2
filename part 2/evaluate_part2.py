...
import config_part2
from train_part2 import evaluate
...
def main(args):
    ...
    maps = torch.load(config_part2.MAPS_PATH)
    ...
    test_trg_lines = update_with_unknown(test_trg_lines, trg_word2idx, unknown_word=config_part2.UNKNOWN_TOKEN)
    ...
    models = torch.load(config_part2.MODEL_CHECKPOINT_PATH)
